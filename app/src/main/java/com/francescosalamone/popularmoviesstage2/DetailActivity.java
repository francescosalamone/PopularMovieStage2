...
import com.francescosalamone.popularmoviesstage2.data.FavoritesContract.*;
import com.francescosalamone.popularmoviesstage2.data.FavoritesDbHelper;
...
import com.francescosalamone.popularmoviesstage2.adapter.ReviewAdapter;
import com.francescosalamone.popularmoviesstage2.adapter.TrailerAdapter;
...
ReviewAdapter.ItemClickListener, TrailerAdapter.ItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Check if already exist the trailers, if no new http request or db query is needed
        ...
        //Check if already exist the reviews object, if no new http request or db query is needed
        ...
        mBinding.fabFavorites.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //First I check if this movie is already my favorite
                if(movieFavorite){
