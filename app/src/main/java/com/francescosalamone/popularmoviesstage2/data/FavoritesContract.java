package com.francescosalamone.popularmoviesstage2.data;

import android.net.Uri;
import android.provider.BaseColumns;

/**
 * Created by Francesco on 11/03/2018.
 */

public class FavoritesContract {

    public static final String AUTHORITY = "com.francescosalamone.popularmoviesstage2";
